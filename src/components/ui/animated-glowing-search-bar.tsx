  ...
  return (
    <div className="relative flex items-center justify-center">
      <div id="poda" className="relative flex items-center justify-center group">
        {/* Outer glow layers */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[600px] rounded-xl blur-[3px]
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[598px] rounded-xl blur-[3px]
        ...
        {/* Inner glow layers */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[593px] rounded-lg blur-[2px]
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[589px] rounded-xl blur-[0.5px]
        ...
        <div id="main" className="relative group">
          <input
            ...
            className="bg-[#010201] border-none w-[580px] h-[56px] rounded-lg text-white px-[59px] text-base focus:outline-none placeholder-zinc-500"
          />
