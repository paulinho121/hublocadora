...
export default function Register() {
    ...
    return (
        <div className="min-h-[100dvh] flex items-center justify-center bg-zinc-950 p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-primary/20 rounded-full blur-[60px] md:blur-[120px]" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-500/10 rounded-full blur-[60px] md:blur-[120px]" />
                ...
                <CardContent>
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <Button 
                            type="button" 
                            variant="outline" 
                            className="w-full h-12 border-zinc-700 bg-white hover:bg-zinc-200 text-black font-bold uppercase tracking-wider transition-colors mt-2" 
